...
void sieve()
{
    ...
    fo(i, 2, 200001)if (isprime[i])primes.pb(i);
}
//  -------------- DIJKSTRA --------------
// ll INF = 1e16;
// void disp(vll v)
...
// vll dx = {1, -1, 0, 0};
// vll dy = {0, 0, 1, -1};
ll n, a[200010], idx, ans1 = 0;
vector<vll> adj(200010);
vll val2(200010);
void dfs(ll v, ll cnt, ll p, ll g)
{
    val2[v] = g;
    if (cnt > ans1)
    {
