...
int main() {
    ...
    // fo(i, 0, f)
    // {
    //     cout << v1[i].first << " " << v5[i].first << " " << v1[i].second << " " << v5[i].second << endl;
    // }
    if (v1.size() != v2.size())
        cout << "No" << endl;
    else {
        d = v1[0].first - v2[0].first + v1[0].second - v2[0].second;
        res = 0;
        fo(i, 1, f)
        {
            ll d1 = v1[i].first - v2[i].first + v1[i].second - v2[i].second;
            if (d != d1)
            {
                res = 1;
                break;
        ...
        {
            d = v1[0].first - v3[0].first + v1[0].second - v3[0].second;
            res = 0;
            fo(i, 1, f)
            {
                ll d1 = v1[i].first - v3[i].first + v1[i].second - v3[i].second;
                if (d != d1)
                {
                    res = 1;
                    break;
            ...
            {
                d = v1[0].first - v4[0].first + v1[0].second - v4[0].second;
                res = 0;
                fo(i, 1, f)
                {
                    ll d1 = v1[i].first - v4[i].first + v1[i].second - v4[i].second;
                    if (d != d1)
                    {
                        res = 1;
                        break;
                ...
                {
                    d = v1[0].first - v5[0].first + v1[0].second - v5[0].second;
                    res = 0;
                    fo(i, 1, f)
                    {
                        ll d1 = v1[i].first - v5[i].first + v1[i].second - v5[i].second;
                        if (d != d1)
                        {
                            res = 1;
                            break;
