    ...
    
    {
        ...
        fo(i,0,n)
        {
            ...
            else if(t[i]==2)
            {
                r1.pb(r[i]*10-1);
                l1.pb(l[i]*10);
                v.pb({l[i]*10,r[i]*10-1});
            }
            else if(t[i]==3)
            {
                r1.pb(r[i]*10);
                l1.pb(l[i]*10+1);
                v.pb({l[i]*10+1,r[i]*10});
            }
            else if(t[i]==4)
            {
                r1.pb(r[i]*10-1);
                l1.pb(l[i]*10+1);
                v.pb({l[i]*10+1,r[i]*10-1});
            }
        }
        sort(all(v));
        sort(all(r1));
        ...
        fo(i,0,n)
        {
            ll idx=lb(r1.begin(),r1.end(),v[i].first)-r1.begin();
            ll idx1=lb(l1.begin(),l1.end(),v[i].second+1)-l1.begin();
            idx1=n-idx1;
            sum+=(n-idx1-idx-1);
