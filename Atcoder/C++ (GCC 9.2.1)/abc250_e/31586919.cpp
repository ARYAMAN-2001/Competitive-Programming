...
int main() {
    ...
    while (t--)
    {
        ...
        ll a[n], i, b[n];
        map<ll, ll> cnt, cnt1;
        vll val(n + 1), val1(n + 1), val2(n + 1), val3(n + 1);
        val1[0] = 1;
        val3[0] = 1;
        fo(i, 0, n)
        {
        ...
        {
            cin >> x >> y;
            // cout << val[x] << " " << val2[y] << " " << val1[x] << " " << val3[y] << endl;
            if (val[x] == val2[y] and val1[x] == val3[y])
                cout << "Yes" << endl;
            else
                cout << "No" << endl;
        }
