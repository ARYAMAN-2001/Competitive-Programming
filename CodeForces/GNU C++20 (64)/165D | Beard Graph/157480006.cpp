...
vll d(200010), deg(200010), val1(200010), val2(200010);
map<pll, ll> m;
ll cnt = 1;
void dfs(ll v)
{
...
int main() {
    ...
    while (q--)
    {
        ...
        else if (z == 1)
        {
            ...
            ll p = val2[x] / 200010;
            ll q = val2[x] % 200010;
            s[p].erase(s[p].find(q));
        }
        else
        {
            cin >> x >> y;
            
            // cout << val1[x] << " " << val1[y] << " " << x << " " << y << endl;
            if (val1[x] != val1[y])
            {
                // if (s[val1[x]].size())
                //     cout << *s[val1[x]].ub(d[x]) << " x " << *s[val1[x]].begin() << endl;
                // if (s[val1[y]].size())
                //     cout << *s[val1[y]].ub(d[y]) << " y " << *s[val1[y]].begin() << endl;
                if (s[val1[x]].size() and s[val1[x]].ub(d[x]) != s[val1[x]].begin())
                    cout << -1 << endl;
                else if (s[val1[y]].size() and s[val1[y]].ub(d[y]) != s[val1[y]].begin())
                    cout << -1 << endl;
                else
                    cout << d[x] + d[y] << endl;
            }
            ...
            {
                ll d1 = min(d[x], d[y]);
                auto it = s[val1[x]].ub(d1);
                if (it != s[val1[x]].end() and * it <= d[y] + d[x] - d1)
                    cout << -1 << endl;
                else
