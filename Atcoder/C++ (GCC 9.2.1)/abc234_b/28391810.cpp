...
//     return ans;
// }
ll dist(pair<ll, ll> p1,
        pll p2)
{
    ll x0 = p1.first - p2.first;
    ll y0 = p1.second - p2.second;
    return x0 * x0 + y0 * y0;
}

// Function to find the maximum
// distance between any two points
double maxDist(pair<long long , long long> p[], ll n)
{
    double Max = 0;
...
int main() {
    ...
    cout << fixed << setprecision(14) << maxDist(v, n) << endl;
