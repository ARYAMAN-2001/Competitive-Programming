...
int main() {
    ...
    fo(i, 0, n)
    {
        ...
        dp[i + 1][0][1] = max(dp[i + 1][0][1], max3(dp[i][1][1], dp[i][2][1], dp[i][0][0]) + a[i][0]);


        //take the 2nd element
        dp[i + 1][1][1] = max(dp[i + 1][1][1], max3(dp[i][1][0], dp[i][2][1], dp[i][0][1]) + a[i][1]);



        //take the 3rd element
        dp[i + 1][2][1] = max(dp[i + 1][2][1], max3(dp[i][1][1], dp[i][2][0], dp[i][0][1]) + a[i][2]);

        dp[i + 1][0][0] = max(dp[i + 1][1][1], dp[i + 1][2][1]);
        dp[i + 1][1][0] = max(dp[i + 1][0][1], dp[i + 1][2][1]);
        dp[i + 1][2][0] = max(dp[i + 1][1][1], dp[i + 1][0][1]);
