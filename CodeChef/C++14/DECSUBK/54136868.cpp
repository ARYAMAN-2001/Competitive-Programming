                ...
                else
                {
                    ...
                    fo(l, 1, n + 1)
                    {
                        ...
                        fo(i, 1, n + 1)
                        {
                            ...
                            if (m1[i] and k - cnt1 >= 1 + max1[i])
                            {
                                // cout << cnt1 << " " << max1[i] << " " << i << endl;
                                ans.pb(i);
                                cnt++;
                                m1[i]--;
                                for (j = n ; j >= 1; j--)
                                {
                                    max1[j] = max(max1[j + 1], m1[j + 1]);
                                }
                                // fo(j, 0, ans.size())
                                // cout << ans[j] << "* ";
                                // cout << endl;
