...
int main() {
    ...
    while(t--)
    {
        ...
        sort(all(v));
        if(v[2].second.first>=v[1].second.first and v[2].second.second>=v[1].second.second and v[1].second.first>=v[0].second.first and v[1].second.second>=v[0].second.second)
        {    
            if(v[2].first+v[2].second.first+v[2].second.second-v[1].first-v[1].second.first-v[1].second.second>=1 and v[1].first+v[1].second.first+v[1].second.second-v[0].first-v[0].second.first-v[0].second.second>=1)
        cout<<"yes"<<endl;
    else
        cout<<"no"<<endl;
}
