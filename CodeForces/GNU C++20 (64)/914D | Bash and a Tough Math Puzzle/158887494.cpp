...
int query(int v, int tl, int tr, int l, int r)
{
    ...
    int tm = (tr + tl) / 2;
    int ans1 = query(2 * v, tl, tm, l, r);
    int ans2 =  query(2 * v + 1, tm + 1, tr, l, r);
    // cout << ans1 << " " << ans2 << " " << tm << " " << endl;
    return min(2, ans1 + ans2);
}
// vll dx = {1, -1, 0, 0};
// vll dy = {0, 0, 1, -1};
