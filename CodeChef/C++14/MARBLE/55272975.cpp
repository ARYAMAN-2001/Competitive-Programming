			...
			fo(i, 0, n)
			{
				if (s[i] != t[i])
				{
					...
					else if (s[i] == '?')
					{
						if (char('a' + k) == t[i])
							continue;
						else if ((k == 0 or k == 4 or k == 8 or k == 14 or k == 20 ) and (t[i] == 'a' or t[i] == 'e' or t[i] == 'i' or t[i] == 'o' or t[i] == 'u' ))
							ans1 += 2;
						else if (!(k == 0 or k == 4 or k == 8 or k == 14 or k == 20 ) and !(t[i] == 'a' or t[i] == 'e' or t[i] == 'i' or t[i] == 'o' or t[i] == 'u' ))
							ans1 += 2;
						else
					...
					else if (t[i] == '?')
					{
						if (char('a' + k) == s[i])
							continue;
						else if ((k == 0 or k == 4 or k == 8 or k == 14 or k == 20 ) and (s[i] == 'a' or s[i] == 'e' or s[i] == 'i' or s[i] == 'o' or s[i] == 'u' ))
							ans1 += 2;
						else if (!(k == 0 or k == 4 or k == 8 or k == 14 or k == 20 ) and !(s[i] == 'a' or s[i] == 'e' or s[i] == 'i' or s[i] == 'o' or s[i] == 'u' ))
							ans1 += 2;
						else
