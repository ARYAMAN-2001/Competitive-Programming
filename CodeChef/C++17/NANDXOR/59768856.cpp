    ...
    while (t--)
    {
                ...
                fo(j, i + 1, n)
                {
                    fo(k, 0, n)
                    {
                        ...
                        fo(l, k + 1, n)
                        {
                            ...
                            ll x = a[i] ^ a[j];
                            ll y = a[k] ^ a[l];
                            ll b = __builtin_popcount(x);
                            ll c = __builtin_popcount(y);
                            if (b == c)
                            {
                                res = 1;
        ...
        else
        {
            ...
            fo(i, 0, 31)
            {
                if (v[i].size() > 1)
                {
                    cout << v[i][0] / 10000000 << " " << v[i][0] % 10000000 << " " << v[i][1] / 10000000 << " " << v[i][1] % 10000000 << endl;
                    break;
                }
            }
        }
